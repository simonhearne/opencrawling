...
class OpenSearch3OutputConnectorTest {

    private OpenSearch3OutputConnector connector;
    ...
    void setUp() {
        ...
        connector = new OpenSearch3OutputConnector(client, embeddingModel);
    }

    @Test
    void testGetName() {
        assertThat(connector.getName()).isEqualTo("OpenSearch3OutputConnector");
    }
